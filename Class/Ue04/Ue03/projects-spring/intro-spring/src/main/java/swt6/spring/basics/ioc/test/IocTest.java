...
public class IocTest {
    ...
    private static void testXmlConfig() {
        try (AbstractApplicationContext factory =
            ...
            WorkLogService workLogService = factory.getBean("worklog-setter-injected", WorkLogService.class);
            workLogService.findEmployeeById(1L);
            workLogService.findEmployeeById(99L);
            workLogService.findAllEmployees();
            ...
            WorkLogService workLogService2 = factory.getBean("worklog-constructor-injected", WorkLogService.class);
            workLogService.findEmployeeById(1L);
            workLogService.findEmployeeById(99L);
            workLogService.findAllEmployees();
        }
